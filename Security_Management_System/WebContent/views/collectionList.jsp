	...
	$.ajax({
		...
		success : function(data){
				...
				for(var i=0;i<result.length;i++){
					...
					+result[i].subService+"</td><td>"+result[i].coreProduct+"</td><td>"+result[i].positiveFactors+"</td><td>"+result[i].nagetiveFactors+"</td><td>"+result[i].positiveMonth+"</td><td><input id='delete' type='image' src='img/delete.png' width=30' height='30'/></td></tr>";
					$('#shares').append(li);
