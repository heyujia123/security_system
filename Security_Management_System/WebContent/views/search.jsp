...
<script type="text/javascript">
	var fresh=function searchShares(){
		...
		$.ajax({
			...
			success : function(data) {
				...
				var li2="<div class='row'><div class='col-md-6 sina'><img class='img-responsive' alt='123' src='"+minUrl+"'/></div>"+
...
<div id="navigation">
			<ul id="nav_list">
				...
				<li id="second" class="nav_active"><a href="search.jsp"><span class="glyphicon glyphicon-search"></span> 实时数据<img
